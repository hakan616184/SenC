...
* **Konum Verileri:** Arka planda GPS takibi yapılmaz. Sadece "Mekan" kategorisinde kendi rızanızla API üzerinden yer etiketi kullandığınızda işlenir.

## 3. Yapay Zeka (AI) Moderasyonu ve Veri Güvenliği
Uygulamaya yüklenen tüm UGC (Kullanıcı Tarafından Oluşturulan İçerik), platform güvenliğini sağlamak amacıyla anlık olarak Yapay Zeka (Gemini AI) ile taranır. Bu tarama işlemi; çıplaklık, şiddet, pedofili ve ifşa (doxxing) gibi yasadışı veya kurallara aykırı içerikleri tespit etmek için yapılır. Yüklediğiniz görseller reklam profillemesi için kullanılmaz veya AI model eğitimi için üçüncü şahıslara satılmaz.

## 4. Veri Saklama, Arşivleme ve Silme
* **Aktif Akış:** Gönderiler, abonelik statünüze bağlı olarak (12 veya 24 saat) oylama akışında kalır.
* **Arşiv:** Süre bitiminde görseller genel akıştan çekilir ve sadece kendi profilinizde şifrelenmiş olarak saklanır.
* **Hesabı ve Verileri Silme:** Uygulama içindeki "Hesabımı Sil" (Delete Account) butonu aracılığıyla, tüm profilinizin, mesajlarınızın, oylarınızın ve görsellerinizin sunucularımızdan kalıcı ve geri döndürülemez şekilde silinmesini sağlayabilirsiniz.

## 5. Üçüncü Taraflarla Veri Paylaşımı ve Uluslararası Aktarım (SCCs)
**KİŞİSEL VERİLERİNİZ HİÇBİR REKLAM VEYA VERİ ŞİRKETİNE SATILMAZ.** Verileriniz yalnızca sistemin çalışması için zorunlu olan küresel hizmet sağlayıcılarıyla (Örn: AWS/Google Cloud depolama, RevenueCat abonelik yönetimi) paylaşılır. AB veya Türkiye dışındaki veri aktarımlarında, Standart Sözleşme Maddeleri (SCCs) gibi yasal koruma mekanizmaları uygulanır.

## 6. Çocukların Gizliliği (COPPA & GDPR Madde 8)
...
## 7. Küresel Kullanıcı Haklarınız (KVKK, GDPR, CCPA)
Kullanıcılar; verilerine erişme, verilerini indirme (Veri Taşınabilirliği), düzeltme, silme (Unutulma Hakkı), işlemenin kısıtlanmasını talep etme ve otomatik karar alma (AI) mekanizmalarına itiraz etme hakkına sahiptir. Kaliforniya sakinleri (CCPA) "Kişisel Verilerimi Satma" hakkına sahiptir (Şirketimiz halihazırda veri satışı yapmamaktadır). Tüm yasal taleplerinizi support@aquaguardwd.com adresine iletebilirsiniz. Talepleriniz 30 gün içinde yanıtlanacaktır.
